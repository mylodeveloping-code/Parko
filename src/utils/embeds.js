...
EmbedBuilder.prototype.setFooter = function setSanitizedFooter(footer) {
    ...
    /*
     * IMPORTANT:
     * Do not silently delete normal footers.
     *
     * The previous implementation only allowed "important" footers,
     * which caused many embeds to lose their footer entirely.
     */
    if (!footerText) {
        return this;
    }
    ...
    const footerObject =
        typeof footer === 'object' && footer !== null
            ? {
                  ...footer,
                  text: footerText,
              }
    ...
    return originalSetFooter.call(this, footerObject);
};

EmbedBuilder.prototype.setTimestamp = function setSafeTimestamp(
    timestamp = new Date(),
) {
    /*
     * The previous implementation completely disabled timestamps.
     * That can break commands which rely on Discord's timestamp field.
     */
    if (timestamp === undefined || timestamp === null) {
        return originalSetTimestamp.call(this, new Date());
    }
