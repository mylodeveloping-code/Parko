...
import {
    readGuildConfig,
    writeGuildConfig,
} from '../../utils/database/guildConfigStorage.js';
import {
...
export const getGuildConfig =
    wrapServiceBoundary(
        ...
        },
        {
            ...
            message:
                'Failed to fetch guild configuration',
            userMessage:
...
export const setGuildConfig =
    wrapServiceBoundary(
        ...
        },
        {
            ...
            message:
                'Failed to save guild configuration',
            userMessage:
...
export const updateGuildConfig =
    wrapServiceBoundary(
        ...
        },
        {
            ...
            userMessage:
                'Failed to update server configuration. Please try again.',
        }
    );
...
export const getConfigValue =
    wrapServiceBoundary(
        ...
        },
        {
            ...
            message:
                'Failed to read guild configuration value',
            userMessage:
                'Failed to read a server setting. Please try again.',
        }
    );
...
export const setConfigValue =
    wrapServiceBoundary(
        ...
        },
        {
            ...
            message:
                'Failed to update guild configuration value',
            userMessage:
                'Failed to update a server setting. Please try again.',
        }
    );

/**
 * Merge partial updates into a nested config object.
 */
export const patchGuildConfig =
    wrapServiceBoundary(
        async function patchGuildConfig(
            client,
            guildId,
            patch,
            context = {}
        ...
        },
        {
            ...
            message:
                'Failed to patch guild configuration',
            userMessage:
                'Failed to update server configuration. Please try again.',
        }
    );

function deepMergeGuildConfig(
    base = {},
    patch = {}
) {
    const result = {
